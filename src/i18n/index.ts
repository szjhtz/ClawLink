...
import enClawlink from './locales/en/clawlink.json';
...
import zhClawlink from './locales/zh/clawlink.json';
...
import jaClawlink from './locales/ja/clawlink.json';
...
import koClawlink from './locales/ko/clawlink.json';
...
i18n
    ...
    .init({
        ...
        fallbackLng: 'en',
        defaultNS: 'common',
        ns: ['common', 'settings', 'dashboard', 'chat', 'channels', 'skills', 'cron', 'setup', 'clawlink'],
        interpolation: {
