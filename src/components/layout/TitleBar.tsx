 ...
 * Windows/Linux: icon + "ClawLink" on left, minimize/maximize/close on right.
 */
...
export function TitleBar() {
  if (isMac) {
    ...
    return <div className="drag-region h-[38px] shrink-0 border-b border-border bg-background" />;
  }
...
function WindowsTitleBar() {
  ...
  return (
    <div className="drag-region flex h-[38px] shrink-0 items-center justify-between border-b border-border bg-background">
      {/* Left: Icon + App Name */}
      <div className="no-drag flex items-center gap-2 pl-3">
        <img src={logoSvg} alt="ClawLink" className="h-5 w-auto" />
