; ClawLink Custom NSIS Installer/Uninstaller Script
;
...
!macro customCheckAppRunning
  ...
  ; dialog during upgrades.  The built-in NSIS uninstaller deletes ClawLink.exe
...
!macro customUnInstall
  ...
  MessageBox MB_YESNO|MB_ICONQUESTION \
    "Do you want to completely remove all ClawLink user data?$\r$\n$\r$\nThis will delete:$\r$\n  • .openclaw folder (configuration & skills)$\r$\n  • AppData\Local\clawlink (local app data)$\r$\n  • AppData\Roaming\clawlink (roaming app data)$\r$\n$\r$\nSelect 'No' to keep your data for future reinstallation." \
  ...
  _cu_enumLoop:
    ...
    RMDir /r "$R2\.openclaw"
    RMDir /r "$R2\AppData\Local\clawlink"
    RMDir /r "$R2\AppData\Roaming\clawlink"
