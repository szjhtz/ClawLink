  ...
  ipcRenderer: {
    invoke: (channel: string, ...args: unknown[]) => {
      const validChannels = [
        ...
        // ClawLink
        'clawlink:saveCurrentUser',
        'clawlink:saveLastSentMessage',
        'clawlink:getLastSentMessage',
        'clawlink:getPrompts',
        'clawlink:stageFromUrl',
        'clawlink:uploadFile',
        'clawlink:downloadAndReveal',
        'clawlink:deployResources',
        'clawlink:factoryReset',
      ];
