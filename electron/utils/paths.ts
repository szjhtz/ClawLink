...
/**
 * Get ClawLink config directory
 */
export function getClawLinkConfigDir(): string {
  return join(homedir(), '.clawlink');
}

/**
 * Get ClawLink logs directory
 */
