 ...
 */
export const PORTS = {
  /** ClawLink GUI development server port */
  CLAWLINK_DEV: 5173,

  /** ClawLink GUI production port (for reference) */
  CLAWLINK_GUI: 23333,

  /** Local host API server port */
  CLAWLINK_HOST_API: 3210,
...
export function getPort(key: keyof typeof PORTS): number {
  const envKey = `CLAWLINK_PORT_${key}`;
...
export const APP_PATHS = {
  ...
  /** ClawLink configuration directory */
  CLAWLINK_CONFIG: '~/.clawlink',
